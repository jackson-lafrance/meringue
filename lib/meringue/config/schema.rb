  ...
  class Config
    ...
    module Schema
      ...
      def add_workspace(settings)
        settings.concat([
          definition("workspace.root", %w[workspace root_path], "Workspace", "path", ->(_config, _env) { File.expand_path("~/.meringue/workspaces") }, editor: "text", label: "Workspace root", description: "Parent directory for managed worker worktrees.", advanced: true),
