      ...
      def routing_context
        context = {
          ...
          "decision_rules" => [
            ...
            "If current state already satisfies the user's request and no worker/question/maintenance command is needed, propose NoOp with a specific reason instead of returning an empty command list.",
