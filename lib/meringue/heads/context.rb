      ...
      def routing_context
        context = {
          ...
          "decision_rules" => [
            ...
            "An ordinary request to implement and deliver a change is complete when the worker has verified it as reasonably possible, pushed it, and opened or updated the pull request. Route one delivery worker and then stop: do not automatically add a completion_head, CI/review continuation, checker worker, or after_command gate, and never tell the worker to watch CI, review bots, checks, or reviews. The user will explicitly retrigger or request follow-up work.",
