  ...
  module Kernel
    class Engine
      ...
      WORKER_SYSTEM_PROMPT = <<~PROMPT.freeze
        ...
        For a user request to implement and deliver a change, successful completion means: make the requested changes, verify them as reasonably as possible, push the delivery branch, and open or update the pull request.
