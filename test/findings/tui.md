...
| Transactional setup flow: first-run/rerun, role defaults, experiment registry, review, skip/cancel, and save failure | `test/integration/tui/onboarding_test.rb` |
| Shared setup overlay: responsive density, registry checkboxes, mouse safety, review, and resize recovery | `test/integration/tui/onboarding_screen_test.rb` |
